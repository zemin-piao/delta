...
trait DeltaSQLConfBase extends DeltaSQLConfUtils {
  ...
  val DELTA_OPTIMIZE_WRITE_BIN_SIZE_SAMPLE_SIZE =
    buildConf("optimizeWrite.binSize.sampleSize")
      .internal()
      .doc("Number of files to sample when estimating avgBytesPerRecord for " +
        "binSize-based maxRecordsPerFile calculation.")
      .intConf
